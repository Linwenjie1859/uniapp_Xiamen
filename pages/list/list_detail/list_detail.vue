<template>
	<view class="margin-bottom-sm">
		...
		<view class="margin-lr-sm">
			...
			<!-- 文章出处信息 Start-->
			<view class="flex margin-tb-xs align-center ">
				...
				<view class="flex flex-direction margin-left-xs">
					<view class="flex align-center">
						<text class="text-black text-bold text-sm">{{article.author}}</text>
						<view class="bg-blue margin-left-xs round padding-lr-xs" style="padding-bottom:5rpx;"> 
			...
			<rich-text class="text-left" style="width: 710rpx;" :nodes="article.content"></rich-text>
		</view>
	</view>
</template>
