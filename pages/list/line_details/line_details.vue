		...
		<view class="footer">
			<view class="footer_list">
				...
				<view class="btn font-24">
					<view class="buy bg_orange white" @click="togglePopup('bottom', 'share')">立即预定</view>
				</view>
			</view>
		</view>
			...
			<view class="uni-padding-wrap">
				<view class="page-section swiper">
					<view class="page-section-spacing">
						<swiper class="swiper" indicator-color="#fff" indicator-active-color="#51c77d" :indicator-dots="indicatorDots"
		...
		<view class="shop_list">
			...
			<view class="list_top">
				...
				<view class="shop_view">
					...
					<view class="time">
						<text class="font-24 static">周末推荐</text>
					</view>
				</view>
			...
			<view class="list_top">
				<view class="title_view">
					<view class="view_left flex">
						...
						<text class="font-28">宝贝评价(22)</text>
					</view>
					<view class="view_right" @tap="details">
						<text class="font-28 gray">查看全部></text>
					</view>
				</view>
				<view class="comments_details flex">
					<image src="/static/pic.png" mode=""></image>
					<text class="font-24">嘻嘻***哈哈</text>
				</view>
				<view class="details_info">
					<text class="title font-28 text_limit">买了好多次了，很好，很新鲜。买了好多买了好多次了，很好</text>
				</view>
			...
			<uni-popup ref="share" :type="type" :custom="true" @change="change">
				<view class="uni-share">
					...
					<view class="cancel" @click="cancel('share')">
						<image src="/static/cancel.png" mode=""></image>
					</view>
					<view class="btn flex">
						<button class="font-28 bg_orange white" @tap="purchase">立即预定</button>
					</view>
