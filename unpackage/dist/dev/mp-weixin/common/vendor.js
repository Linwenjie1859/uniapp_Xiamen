...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance");}function _iterableToArrayLimit(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;}var formatTime = function formatTime(date) {
...
/**
    ...
    * 
   */
var getUrlParams = function getUrlParams(param, k, p) {
...
/*
   ...
   */
var basePost = function basePost(url, data, successCallback, errorCallback, header) {
...
/*
   ...
   */
var baseGet = function baseGet(url, successCallback, errorCallback, isMsg, header) {
  if (typeof url == 'object') url = U(url);
  uni.request({
    url: url,
    dataType: 'json',
...
/*
   * 合并数组
   */
var SplitArray = function SplitArray(list, sp) {
...
/*
   ...
   * @param callable errorCallback 失败执行方法 
   */
var uploadImageOne = function uploadImageOne(opt, successCallback, errorCallback) {
  if (typeof opt === 'string') {
    var url = opt;
    opt = {};
    opt.url = url;
...
/**
    ...
    * 
   */
var ArrayRemove = function ArrayRemove(array, index, value) {
  var valueArray = [];
...
/**
    ...
    * @return array 
   */
var textByteLength = function textByteLength(text, num) {
  var strLength = 0;
  var rows = 1;
  var str = 0;
  var arr = [];
...
/**
    ...
    * 
   */
var PosterCanvas = function PosterCanvas(arr2, store_name, price, successFn) {
  ...
  uni.getImageInfo({
    ...
    success: function success(res) {
      ...
      ctx.restore();
      var CONTENT_ROW_LENGTH = 40;var _textByteLength =
      textByteLength(store_name, CONTENT_ROW_LENGTH),_textByteLength2 = _slicedToArray(_textByteLength, 3),contentLeng = _textByteLength2[0],contentArray = _textByteLength2[1],contentRows = _textByteLength2[2];
      ctx.setTextAlign('center');
      ctx.setFontSize(32);
      var contentHh = 32 * 1.3;
...
/**
    ...
    * */
var AnimationNumber = function AnimationNumber(BaseNumber, ChangeNumber, that, name) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    loginStore: function loginStore(state, provider) {
    ...
    logoutStore: function logoutStore(state) {
      state.token = '';
      state.isLog = false;
    },
    setNavHeight: function setNavHeight(state, provider) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__708535A" };exports.default = _default;
